...
$(function() {
    var playerTrack = $("#player-track"),
        ...
        buffInterval = null,
        tFlag = false,
        albums = ['Rubber Band Boiz', 'Goin In', '100s', 'Cinema', 'Riot', 'SURVIVAL', 'FALLING', 'The Wonky Song', 'Takin Over', 'Riddim Love Song', 'First Of The Year (Equinox)', 'Kill The Noise  Recess', 'Rock n Roll', 'Make It Bun Dem', 'TRY IT OUT', 'Bangarang', 'Pray For Riddim', 'Purple Dragons', ' Immunity', 'Resurrected'],
